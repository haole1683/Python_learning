...
>>> 
====================== RESTART: D:\Python\2019-8-15.py ======================
Traceback (most recent call last):
  File "D:\Python\2019-8-15.py", line 21, in <module>
    data = urllob.parse.urlencode(data).encode('utf-8')
NameError: name 'urllob' is not defined
>>> 
====================== RESTART: D:\Python\2019-8-15.py ======================
{"errorCode":50}
>>> 
...
<ul class="fanyi__nav__list">
    ...
    <div class="side__nav">
        ...
        <a target="_blank" href="http://survey2.163.com/html/fanyis201103a2/paper.html?id=800721101@10.108.160.17@0" class="side__nav__feedback">满意度<br/>反馈</a>
